...
public class KafkaConsumerJavaDemo {
	...
	private final static String TOPIC = "Aug20"; // This is the topic name you create through CLI
	private final static String BOOTSTRAP_SERVERS = "localhost:9092"; // This is the host where your kafka server is running.
	private final static String filePath ="C:\\Users\\pavan\\Desktop\\bootcampOutput\\KafkaOutput\\Output.txt"; // This is the output path.
	private final static String hdfsFilePath ="hdfs://localhost:50071//BT//kafkaoutput.txt";
